        ...
        <div class="card-body">
            <form action="{{ route('lapangans.update', $lapangan->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror"
                            ...
                            <option value="tidak_tersedia" {{ old('status', $lapangan->status) == 'tidak_tersedia' ? 'selected' : '' }}>Tidak Tersedia</option>
                        </select>
                        @error('status')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <img src="{{ asset('storage/' . $lapangan->foto) }}" alt="{{ $lapangan->nama_lapangan }}" class="img-fluid rounded" style="max-height: 200px;">
                    </div>
                </div>
                @endif
